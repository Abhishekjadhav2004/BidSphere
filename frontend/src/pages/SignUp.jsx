...
//       formData.append("PaypalAccountNumber", easypaisaAccountNumber),
...
//                     <option value="Meezan Bank">SBI Bank</option>
//                     <option value="UBL">Central Bank</option>
//                     <option value="HBL">HDFC Bank</option>
//                     <option value="Allied Bank">Vidharab Bank</option>
//                   </select>
//                   <input
//                     type="text"
...
//                     placeholder=" Paypal Account Number"
...
const SignUp = () => {
  ...
  const [bankAccountNumber, setBankAccountNumber] = useState("");
  const [bankName, setBankName] = useState("");
  // REMOVED easypaisaAccountNumber
  const [paypalEmail, setPaypalEmail] = useState("");
  const [profileImage, setProfileImage] = useState("");
  const [profileImagePreview, setProfileImagePreview] = useState("");
              ...
              <div className="flex flex-col sm:flex-1">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (val.length <= 10) setPhone(val.slice(0, 10));
                  }}
                  className="text-[18px] py-3 bg-[#F2F5F9] border-b-[2px] border-b-amber-600 focus:outline-none rounded-lg px-3 font-medium placeholder:text-gray-400 focus:bg-white transition-colors duration-200"
                  placeholder="Phone (10 digits only)"
                />
                {phoneError && <p className="text-red-600 mt-1 text-[16px]">{phoneError}</p>}
              </div>
              <div className="flex flex-col sm:flex-1">
                <label className="text-[16px] text-stone-600">Address</label>
                <input
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="HBL">Central Bank</option>
                    <option value="Allied Bank">Nationl Bank</option>
                  </select>
                  <input
                    type="text"
                    value={bankAccountNumber}
